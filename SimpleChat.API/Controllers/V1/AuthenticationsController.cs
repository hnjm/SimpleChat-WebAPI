...
#pragma warning restore 1591
        ...
        /// <response code="204">DB query result</response>
        ...
        [ProducesResponseType(StatusCodes.Status204NoContent, Type = typeof(IsUserExistVM))]
        ...
        public async Task<JsonResult> IsUserExist([FromQuery] string userName, [FromQuery] string eMail)
        {
            ...
            if (isUserNameExist || isEmailExist)
                ...
                return new JsonAPIResult(model, StatusCodes.Status204NoContent);
        }
