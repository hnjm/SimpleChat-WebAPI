...
#pragma warning restore 1591
        ...
        /// <response code="204">If the user credentials not matched with any registered users</response>
        ...
        /// <response code="400">If posted data is not valid, it returns APIResultVM which is contains error-codes</response>
        /// <response code="204">If the tokens not attached to any registered users</response>
