...
#pragma warning restore 1591
        ...
        public JsonResult GetById([FromRoute] Guid id)
        {
            ...
            return new JsonAPIResult(APIResult.CreateVMWithRec<UserVM>(result, true, result.Id),
        ...
        public async Task<JsonResult> Update([FromRoute] Guid id, [FromBody] UserUpdateVM model)
        {
            ...
            if(currentUser.Id != user.Id)
                return new JsonAPIResult(APIResult.CreateVMWithStatusCode(false, null, APIStatusCode.ERR01007),
            ...
            if (!result.Succeeded)
                return new JsonAPIResult(APIResult.CreateVMWithStatusCode(false, null, APIStatusCode.ERR01010),
                    StatusCodes.Status422UnprocessableEntity);

            return new JsonAPIResult(APIResult.CreateVM(true, user.Id), StatusCodes.Status200OK);
        }
