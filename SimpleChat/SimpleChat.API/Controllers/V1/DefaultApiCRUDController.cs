...
#pragma warning restore 1591
        ...
        public virtual async Task<JsonResult> Add([FromBody] A model)
        {
            ...
            return new JsonAPIResult(APIResult.CreateVM(result.ResultIsTrue(), result.RecId),
        ...
        public virtual async Task<JsonResult> Update([FromRoute] Guid id, [FromBody] U model)
        {
            if (!ModelState.IsValid)
                ...
                return new JsonAPIResult(APIResult.CreateVMWithStatusCode(statusCode: APIStatusCode.ERR01003),
                    StatusCodes.Status400BadRequest);
